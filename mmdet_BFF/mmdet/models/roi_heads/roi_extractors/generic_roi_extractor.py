...
class GenericRoIExtractor(BaseRoIExtractor):
    ...
    def forward(self, feats, feats1, rois, roi_scale_factor=None):
        ...
        if self.with_post:
            ...
            roi_feats1 = self.post_module(roi_feats1)
        return roi_feats+roi_feats1
